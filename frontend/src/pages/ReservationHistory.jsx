...
const MetricCard = ({ title, value, onClick }) => (
  <div onClick={onClick} className={`p-6 rounded-2xl shadow-lg cursor-pointer transform transition hover:scale-105 bg-white border border-gray-100`}>
      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-200">
              {[1, 2, 3, 4, 5].map((i) => (
                <tr key={i} className="hover:bg-gray-50 transition-all duration-300 even:bg-gray-50/50">
                  ...
                  <td className="px-10 py-8">
                    <span className={`px-8 py-4 rounded-full text-white font-bold shadow-md ${activeType === 'Successful' ? 'bg-green-600' :
                  ...
                  <td className="px-10 py-8">
                    <button className="bg-teal-600 hover:bg-teal-700 text-white font-bold text-lg px-12 py-5 rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300">
                      View Details
                    </button>
                  </td>
                </tr>
        ...
        <div className="p-10 border-t border-gray-200 flex justify-center bg-gray-50">
          <div className="flex gap-6">
            ...
            <button className="px-10 py-5 rounded-xl bg-teal-600 text-white font-bold text-lg shadow-lg">1</button>
