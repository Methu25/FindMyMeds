      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden">
                ...
                <tr key={i} className="hover:bg-gray-50 transition-all duration-300 even:bg-gray-50/50">
                  ...
                  <td className="px-10 py-8 space-x-4">
                    {activeStatus === 'Pending' && (
                      <>
                        <button className="bg-teal-600 hover:bg-teal-700 text-white font-bold px-8 py-4 rounded-xl shadow-lg hover:shadow-xl transition">
                          Confirm
                        </button>
        ...
        <div className="p-10 border-t border-gray-200 flex justify-center">
          <div className="flex gap-4">
            ...
            <button className="px-8 py-4 rounded-xl bg-teal-600 text-white font-bold text-lg shadow-lg">1</button>
